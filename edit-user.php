...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title> CM Manager | Modifier CM</title>
                        ...
                        <nav class="menu">
                            <ul class="nav metismenu" id="sidebar-menu">
                                ...
                                <li class="active open">
                                    <a href=""> <i class="fa fa-users"></i> Utilisateurs <i class="fa arrow"></i> </a>
                                    <ul>
                                        ...
                                        <li class="active"> <a href="edit-user.php">
                                            Modifier CM
                                        </a> </li>
                ...
                <article class="content items-list-page">
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                               <div class="col-md-6">
                                     <h3 class="title"><i class="fa fa-user"> Modifier CM  
                                    </i></h3>
                                </div>
						...
						<div class="form-group">
							...
							<div class="col-lg-12">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="name" id="name"  placeholder="Nom affiché de l'utilisateur" value="<?php echo ucfirst($data['nom_u']);?>" required/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-12">
								<div class="input-group">
									...
									<input type="email" class="form-control" name="email" id="email"  placeholder="Adresse E-mail (login)" value="<?php echo $data['email_u'];?>" required/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-12">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="password" id="password"  placeholder="Mot de passe" value="<?php echo $data['pwd_u'];?>" required/>
								</div>
							</div>
						</div>
